"! Copy of /mbtools/cx_exception from
"! https://github.com/Marc-Bernard-Tools/MBT-Package-Manager/blob/main/src/core/%23mbtools%23cx_exception.clas.abap
CLASS zcx_certi_mbt DEFINITION
  PUBLIC
...
CLASS zcx_certi_mbt IMPLEMENTATION.
  ...
  METHOD raise_t100.
    ...
    RAISE EXCEPTION TYPE zcx_certi_mbt
      EXPORTING
        textid   = ls_t100_key
        msgv1    = iv_msgv1
        msgv2    = iv_msgv2
