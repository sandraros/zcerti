...
CLASS zcx_certi_mbt DEFINITION LOCAL FRIENDS ltcl_test.
...
CLASS ltcl_test IMPLEMENTATION.
  METHOD test_direct_text.
    ...
    DATA: lx_ex       TYPE REF TO zcx_certi_mbt,
    ...
    TRY.
        ...
        zcx_certi_mbt=>raise( iv_text     = lx_previous->get_text( )
                                      ix_previous = lx_previous ).
        cl_abap_unit_assert=>fail( ).

      CATCH zcx_certi_mbt INTO lx_ex.
    ...
    TRY.
        zcx_certi_mbt=>raise( lc_text2 ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_certi_mbt INTO lx_ex.
        cl_abap_unit_assert=>assert_equals(
          act = get_exc_text( lx_ex )
          exp = zcx_certi_mbt=>gc_generic_error_msg ).
    ENDTRY.
